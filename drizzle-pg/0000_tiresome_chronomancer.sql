...
CREATE INDEX "items_project_status_idx" ON "items" USING btree ("project_id","status");--> statement-breakpoint
CREATE UNIQUE INDEX "projects_one_default_per_organization_idx" ON "projects" USING btree ("organization_id") WHERE "projects"."name" = 'Default' AND "projects"."domain" IS NULL AND "projects"."archived_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX "sam_sessions_project_updated_idx" ON "sam_sessions" USING btree ("project_id","updated_at");--> statement-breakpoint
